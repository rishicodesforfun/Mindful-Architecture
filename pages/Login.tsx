...
const Login: React.FC = () => {
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-[#fafafa] dark:bg-[#0B1015] text-[#111618] dark:text-gray-100 font-['Epilogue'] overflow-hidden px-8 transition-colors duration-300">
